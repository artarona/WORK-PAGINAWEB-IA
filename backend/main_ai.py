...
from backend.logic.database import (
...
origins = [
    "*", # Permitir temporalmente para pruebas, luego restringir
...
if __name__ == "__main__":
    ...
    uvicorn.run("backend.main_ai:app", host="0.0.0.0", port=8080, reload=False)